<?php
namespace PWC\CustomShipping\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        $amount = $this->calculateCustomShippingPrice();       
    ...
    public function calculateCustomShippingPrice()
    {
        ...
        foreach($items as $item) {
            ...
            $productType = $this->productFactory->getData('product_shipping_type');
